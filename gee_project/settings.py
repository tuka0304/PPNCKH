"""
Django settings for gee_project project.
...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-aesdu#@z@0hbo%g-@*yog48axzk@t%0^-qvc+xau6orvi=+i!*')
...
WSGI_APPLICATION = 'gee_project.wsgi.application'
